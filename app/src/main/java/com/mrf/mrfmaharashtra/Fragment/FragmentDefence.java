...
public class FragmentDefence extends Fragment {
    ...
    private void setAdapter() {
        ...
        mAdapter = new SelfDefenceAdapter(subcategorylist, getActivity());
        recyclerView.setAdapter(mAdapter);
    }
    public class  SelfDefenceAdapter extends  RecyclerView.Adapter<SelfDefenceAdapter.ViewHolder> {
        //ArrayList source;

        private List<SopsModel> mModel;
        private Context mContext;

        public SelfDefenceAdapter(List<SopsModel> mModel, Context mContext) {
            this.mModel = mModel;
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
            ...
            holder.cd_SopsContent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Log.e("id" ,""+id);
                    replaceFragmentWithAnimation(new FragmentPdfSelfDefence(),id,pdf_content);
                }
            });
