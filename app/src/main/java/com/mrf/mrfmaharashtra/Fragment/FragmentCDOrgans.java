...
public class FragmentCDOrgans extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MainActivity.tvHeaderText.setText(getString(R.string.organ));
   ...
   /* private void replaceFragmentWithAnimation(FragmentCDOrgans fragmentCDOrgans) {
    ...
    public class CDOrgnAadapter extends  RecyclerView.Adapter<CDOrgnAadapter.ViewHolder> {
      ...
      /*  ArrayList personNames;
        ...
        public CDOrgnAadapter(List<SopsModel> mModel, Context mContext) {
            this.mModel = mModel;
            this.mContext = mContext;

        }

       /* public CDOrgnAadapter(Context context, ArrayList personNames) {
