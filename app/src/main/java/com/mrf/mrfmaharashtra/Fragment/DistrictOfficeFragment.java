...
public class DistrictOfficeFragment extends Fragment {
    ...
    private void ApiDistrictHelp(final String id) {
    ...
    private void setAdapter() {
        ...
        mAdapter = new DistrictHelpAdapter(subcategorylist, getActivity());
    ...
    public class DistrictHelpAdapter extends  RecyclerView.Adapter<DistrictHelpAdapter.ViewHolder> {


        private List<SopsModel> mModel;
        private Context mContext;

        public DistrictHelpAdapter(List<SopsModel> mModel, Context mContext) {
            this.mModel = mModel;
