...
public class DelhiHospitalHelpline extends Fragment {
    ...
    private void ApiDelhiHelp(final String id) {
    ...
    private void setAdapter() {
        ...
        mAdapter = new DelhiHelpAdapter(subcategorylist, getActivity());
    ...
    public class DelhiHelpAdapter extends  RecyclerView.Adapter<DelhiHelpAdapter.ViewHolder> {


        private List<SopsModel> mModel;
        private Context mContext;

        public DelhiHelpAdapter(List<SopsModel> mModel, Context mContext) {
            this.mModel = mModel;
