...
public class FragmentCdComm extends Fragment {
    ...
    private void setAdapter() {
        ...
        mAdapter = new MrfCommAdapter(subcategorylist, getActivity());
        recyclerView.setAdapter(mAdapter);
    }
    public class MrfCommAdapter extends  RecyclerView.Adapter<MrfCommAdapter.ViewHolder> {
        //ArrayList source;

        private List<SopsModel> mModel;
        private Context mContext;

        public MrfCommAdapter(List<SopsModel> mModel, Context mContext) {
            this.mModel = mModel;
