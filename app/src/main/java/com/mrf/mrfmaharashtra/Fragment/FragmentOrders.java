...
public class FragmentOrders extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MainActivity.tvHeaderText.setText(getString(R.string.order));
    ...
    private void setAdapter() {
        ...
        mAdapter = new OrderAdapter(subcategorylist, getActivity());
    ...
    public class OrderAdapter extends  RecyclerView.Adapter<OrderAdapter.ViewHolder> {
        ...
        public OrderAdapter(List<SopsModel> mModel, Context mContext) {
            this.mModel = mModel;
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
            ...
            holder.cd_SopsContent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Log.e("id" ,""+id);
                    replaceFragmentWithAnimation(new FragmentPdfOrders(),id,pdf_content);
                }
            });
