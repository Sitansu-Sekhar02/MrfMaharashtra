...
public class FragmentRescue extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MainActivity.tvHeaderText.setText(getString(R.string.resque));
    ...
    private void setAdapter() {
        ...
        mAdapter = new RescueAdapter(subcategorylist, getActivity());
    ...
    public class RescueAdapter extends  RecyclerView.Adapter<RescueAdapter.ViewHolder> {
        ...
        public RescueAdapter(List<SopsModel> mModel, Context mContext) {
            this.mModel = mModel;
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
            ...
            holder.cd_SopsContent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Log.e("id" ,""+id);
                    replaceFragmentWithAnimation(new FragmentPdfRescue(),id,pdf_content);
                }
            });
