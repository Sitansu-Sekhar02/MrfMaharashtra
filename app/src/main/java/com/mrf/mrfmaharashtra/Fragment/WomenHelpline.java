...
public class WomenHelpline extends Fragment {
    ...
    private void ApiWomenHelp(final String id) {
    ...
    private void setAdapter() {
        ...
        mAdapter = new WomenHelpAdapter(subcategorylist, getActivity());
    ...
    public class WomenHelpAdapter extends  RecyclerView.Adapter<WomenHelpAdapter.ViewHolder> {


        private List<SopsModel> mModel;
        private Context mContext;

        public WomenHelpAdapter(List<SopsModel> mModel, Context mContext) {
            this.mModel = mModel;
