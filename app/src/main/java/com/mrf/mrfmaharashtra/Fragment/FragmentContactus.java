...
public class FragmentContactus extends Fragment {
    ...
    private void setAdapter() {
        ...
        mAdapter = new ContactUsAdapter(subcategorylist, getActivity());
    ...
    public class  ContactUsAdapter extends  RecyclerView.Adapter<ContactUsAdapter.ViewHolder> {
        ...
        public ContactUsAdapter(List<SopsModel> mModel, Context mContext) {
            this.mModel = mModel;
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
            ...
            holder.cd_SopsContent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Log.e("id" ,""+id);
                    replaceFragmentWithAnimation(new FragmentPdfContactUs(),id,pdf_content);
                }
            });
